    ...
    <div className="border border-gray-300 ml-36 rounded-md w-2/4 mr-20 flex flex-col h-full mb-16">
      ...
      <div className="flex-grow h-96 overflow-y-auto">
        {selectedProducts.map((product, index) => (
          <div
            key={index}
            className="ml-16 mb-5 mt-5 border-2 border-gray-300 rounded-md p-5 mr-16 font-raleway flex justify-between items-center"
          >
            <div className="flex items-center">
              ...
              />
              <span className="mr-2">{product.nombre}</span>
            ...
            <div className="flex items-center">
              <input
                ...
                className="border border-gray-300 rounded-md w-10 text-center mr-10"
              />
              <button
              ...
              >
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-trash3-fill text-red-500 my-auto"
                  viewBox="0 0 16 16"
                >
